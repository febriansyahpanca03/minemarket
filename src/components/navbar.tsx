    ...
    <header className="sticky top-0 z-50 h-16 border-b border-white/10 bg-slate-950/80 backdrop-blur-md">
      <div className="mx-auto flex h-full max-w-6xl items-center justify-between px-4">
        ...
        <nav className="hidden items-center gap-7 text-sm font-medium text-slate-300 md:flex">
          ...
          <Link href="/products?category=minecraft-accounts" className="transition hover:text-white">
            Accounts
          </Link>
          <Link href="/products?category=minecoin" className="transition hover:text-white">
            Minecoin
          </Link>
        </nav>
